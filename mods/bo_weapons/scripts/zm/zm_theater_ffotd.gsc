...
function main_end()
{
	...
	if(GetGametypeSetting(mutator_kino_stageclimb) == MUTATOR_ONOFF_OFF)
	{
		foreach(node in GetAllNodes())
		{
			//there better be none other than at the front of the stage
			if(node.animscript == "jump_up_72" || node.animscript == "jump_down_72")
