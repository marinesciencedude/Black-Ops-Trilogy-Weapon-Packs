...
function main_end()
{
	...
	case 1:
		...
		break;
	case 3:
		level.var_f3798849 = getweapon("t5_l96a1_switch");
		break;
	default:
		level.var_f3798849 = getweapon("t5_l96a1");
		break;
	}
	
	level.var_c29d7558 = getweapon("t5_m72");
	level.var_b00f35c1 = getweapon("t5_m14");
	
	level.var_b39227d1 = array(getweapon("t5_mp40"), getweapon("t5_spas12"), getweapon("t5_commando"), getweapon("t5_hk21"), getweapon("t5_m14"), getweapon("t5_mp5k"));
	
	/*if(GetDvarInt("mutator_ray_gun") == 2)
		raygun = getweapon("ray_gun");
	else
		raygun = getweapon("t4_ray_gun");*/
	
	switch(GetDvarInt("mutator_scopeads"))
	{
	case 1:
		dragunov = getweapon("t5_dragunov_overlay");
		break;
	case 3:
		dragunov = getweapon("t5_dragunov_switch");
		break;
	default:
		dragunov = getweapon("t5_dragunov");
		break;
	}
	
	level.var_8aee1d4 = array(getweapon("t5_hs10"), /*getweapon("shotgun_fullauto"),*/ dragunov, getweapon("t4_ray_gun"), getweapon("bowie_knife"), getweapon("cymbal_monkey"));
