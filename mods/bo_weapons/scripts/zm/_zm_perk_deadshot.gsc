...
{	
	...
	if(GetDvarInt("mutator_deadshot_price") == 1)
		perk_cost = 1000;
	else
		perk_cost = 1500;
	
	zm_perks::register_perk_basic_info( PERK_DEAD_SHOT, "deadshot", perk_cost, &"ZOMBIE_PERK_DEADSHOT", GetWeapon( DEADSHOT_PERK_BOTTLE_WEAPON ) );
