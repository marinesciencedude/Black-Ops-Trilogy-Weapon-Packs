...
function __init__()
{
	...
	clientfield::register( "clientuimodel", "hudItems.perks.doublePointsActive_bo", VERSION_SHIP, 2, "int" ); //I am lazy
}
...
function double_points_powerup( drop_item, player )
{
	...
	for ( player_index = 0; player_index < players.size; player_index++ )
	{
		...
		{
			if(level.TFOptions["bo_powerup_icons"] == 1)
				players[player_index] clientfield::set_player_uimodel( "hudItems.perks.doublePointsActive_bo", 1 ); //I am lazy
			else
	...
	for ( player_index = 0; player_index < players.size; player_index++ )
	{
		...
		{
			if(level.TFOptions["bo_powerup_icons"] == 1)
				players[player_index] clientfield::set_player_uimodel( "hudItems.perks.doublePointsActive_bo", 0 ); //I am lazy
			else
