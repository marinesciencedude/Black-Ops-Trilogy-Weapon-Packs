...
CoD.PowerUps.ClientFieldNames = {
	{
		...
		image = "t5_powerup_instant_kill"
	},
	{
		clientFieldName = "powerup_double_points",
		image = "t5_powerup_double_points"
	},
	{
		clientFieldName = "powerup_fire_sale",
		image = "t5_powerup_fire_sale"
	},
	{
		clientFieldName = "powerup_mini_gun",
		image = "t5_powerup_mini_gun"
	},
	{
...
CoD.KingslayerPowerupsContainer.new = function ( menu, controller )
	...
	self.PowerupList:setLeftRight( false, false, -72.5, 0 )
	self.PowerupList:setTopBottom( false, true, 0, -5 )
