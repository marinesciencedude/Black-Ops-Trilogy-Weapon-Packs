...
function CoD.T5ScoreWidget.new( menu, controller )
    ...
    ZMPlayerList:setTopBottom( false, true, ( ( ( CoD.T5ScoreWidget.Bottom - ( CoD.T5ScoreWidget.RowHeight * CoD.T5ScoreWidget.ScoreBottomOffset ) ) - CoD.T5ScoreWidget.RowHeight ) - 5 ) - 20, ( ( CoD.T5ScoreWidget.Bottom - ( CoD.T5ScoreWidget.RowHeight * CoD.T5ScoreWidget.ScoreBottomOffset ) ) + 5 ) - 20 )
