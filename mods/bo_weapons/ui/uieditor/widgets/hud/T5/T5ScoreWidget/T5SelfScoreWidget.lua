...
CoD.T5SelfScoreWidget = InheritFrom( LUI.UIElement )

function CoD.T5SelfScoreWidget.new( menu, controller )
    local self = LUI.UIElement.new()
    self:setClass(CoD.T5SelfScoreWidget)
    self.id = "T5SelfScoreWidget"
    self.soundSet = "default"
    self.anyChildUsesUpdateState = true

    self:setLeftRight(false, true, ((-CoD.T5ScoreWidget.RowWidth) - 8), 0)
    self:setTopBottom(false, true, (((CoD.T5ScoreWidget.Bottom - (CoD.T5ScoreWidget.RowHeight * 2)) - CoD.T5ScoreWidget.RowHeight) - 5), ((CoD.T5ScoreWidget.Bottom - (CoD.T5ScoreWidget.RowHeight * 2)) + 5))
    ...
    local function UpdateScore(newScore)
        ...
        self:addElement(CoD.T5GlowScoreWidget.new(menu, controller, scoreDiff, isPositive, 1.0))
    end
