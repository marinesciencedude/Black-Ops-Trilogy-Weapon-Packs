...
local PostLoadFunc = function ( self, controller )
	...
	--[[or index = 1, #CoD.PowerUps.ClientFieldNames do
...
CoD.T5Notification = InheritFrom( LUI.UIElement )
CoD.T5Notification.new = function ( menu, controller )
	...
	self:setClass( CoD.T5Notification )
	self.id = "T5Notification"
	self.soundSet = "HUD"
	...
	self.text:setTopBottom( true, false, 428, 484 )
	self.text:setText( Engine.Localize( "" ) )
	self.text:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
		...
		DefaultState = {
			...
			Powerup = function ()
				...
				local PowerupAnim2 = function ( element, event )
					...
					element:setTopBottom( true, false, 428 - 25, 484 - 25 )
					element:setAlpha( 0 )
