...
CoD.T5AmmoWarning.new = function ( menu, controller )
	...
	self.WarningTextShadow:setLeftRight( true, true, 378 + 0.5, 0 + 0.5 )
	self.WarningTextShadow:setTopBottom( true, false, 409.5 + 0.5, 439.5 + 0.5 )
	self.WarningTextShadow:setText( Engine.Localize( "" ) )
	self.WarningTextShadow:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	self.WarningTextShadow:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_LEFT )
	...
	self.WarningText:setLeftRight( true, true, 378, 0 )
	self.WarningText:setTopBottom( true, false, 409.5, 439.5 )
	self.WarningText:setText( Engine.Localize( "" ) )
	self.WarningText:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	self.WarningText:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_LEFT )
	...
	self.clipsPerState = {
		...
		Reload = {
			DefaultClip = function ()
				...
				self.WarningText:completeAnimation()
				self.WarningText:setAlpha( 1 )
				self.WarningText:setText( Engine.Localize( "  ^3[{+reload}]^7 Reload" ) )
				self.WarningText:setRGB( 1, 1, 1 )
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				return ammoStock <= (ammoStockMax / 6)
			end
		},
		{
			stateName = "Reload",
