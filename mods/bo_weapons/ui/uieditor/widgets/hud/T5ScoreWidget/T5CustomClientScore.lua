CoD.T5CustomClientScore = InheritFrom( LUI.UIElement )
CoD.T5CustomClientScore.new = function ( menu, controller )
	...
	self:setClass( CoD.T5CustomClientScore )
	self.id = "T5CustomClientScore"
