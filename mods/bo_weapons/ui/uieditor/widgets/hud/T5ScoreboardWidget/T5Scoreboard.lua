...
CoD.T5Scoreboard.new = function ( menu, controller )
	...
	self.GameOverShadow = LUI.UIText.new()
	self.GameOverShadow:setLeftRight( true, true, 0 + 1, 0 + 1 )
	self.GameOverShadow:setTopBottom( true, false, 127 + 1, 210 + 1 )
	self.GameOverShadow:setText( Engine.Localize( "ZOMBIE_GAME_OVER" ) )
	self.GameOverShadow:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	self.GameOverShadow:setRGB( 0, 0, 0 )
	self.GameOverShadow:setScale( 0.5 )
	self.GameOverShadow:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_CENTER )
	self:addElement( self.GameOverShadow )

	self.GameOver = LUI.UIText.new()
	self.GameOver:setLeftRight( true, true, 0, 0 )
	self.GameOver:setTopBottom( true, false, 127, 210 )
	self.GameOver:setText( Engine.Localize( "ZOMBIE_GAME_OVER" ) )
	self.GameOver:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	self.GameOver:setScale( 0.5 )
	self.GameOver:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_CENTER )
	self:addElement( self.GameOver )

	self.SurvivedShadow = LUI.UIText.new()
	self.SurvivedShadow:setLeftRight( true, true, 0 + 1, 0 + 1 )
	self.SurvivedShadow:setTopBottom( true, false, 184.5 + 1, 240.5 + 1 )
	self.SurvivedShadow:setText( Engine.Localize( "You Survived 1 Round" ) )
	self.SurvivedShadow:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	self.SurvivedShadow:setRGB( 0, 0, 0 )
	self.SurvivedShadow:setScale( 0.5 )
	self.SurvivedShadow:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_CENTER )
	self.SurvivedShadow:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "gameScore.roundsPlayed" ), function ( model )
		local roundsPlayed = Engine.GetModelValue( model )

		if roundsPlayed then
			if (roundsPlayed - 1) > 1 then
				self.SurvivedShadow:setText( "You Survived " .. Engine.Localize( roundsPlayed - 1 ) .. " Rounds" )
			else
				self.SurvivedShadow:setText( "You Survived " .. Engine.Localize( roundsPlayed - 1 ) .. " Round" )
			end
		end
	end )
	self:addElement( self.SurvivedShadow )

	self.Survived = LUI.UIText.new()
	self.Survived:setLeftRight( true, true, 0, 0 )
	self.Survived:setTopBottom( true, false, 184.5, 240.5 )
	self.Survived:setText( Engine.Localize( "You Survived 1 Round" ) )
	self.Survived:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	...
	self.ScoreColumn1Shadow:setLeftRight( true, true, 347 + 0.5, 0 + 0.5 )
	self.ScoreColumn1Shadow:setTopBottom( true, false, 249 + 0.5, 284 + 0.5 )
	self.ScoreColumn1Shadow:setText( Engine.Localize( "Points" ) )
	self.ScoreColumn1Shadow:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	...
	self.ScoreColumn1:setLeftRight( true, true, 347, 0 )
	self.ScoreColumn1:setTopBottom( true, false, 249, 284 )
	...
	self.ScoreColumn2Shadow:setLeftRight( true, true, 454 + 0.5, 0 + 0.5 )
	self.ScoreColumn2Shadow:setTopBottom( true, false, 249 + 0.5, 284 + 0.5 )
	self.ScoreColumn2Shadow:setText( Engine.Localize( "Kills" ) )
	self.ScoreColumn2Shadow:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	...
	self.ScoreColumn2:setLeftRight( true, true, 454, 0 )
	self.ScoreColumn2:setTopBottom( true, false, 249, 284 )
	...
	self.ScoreColumn3Shadow:setLeftRight( true, true, 538 + 0.5, 0 + 0.5 )
	self.ScoreColumn3Shadow:setTopBottom( true, false, 249 + 0.5, 284 + 0.5 )
	self.ScoreColumn3Shadow:setText( Engine.Localize( "Downs" ) )
	self.ScoreColumn3Shadow:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	...
	self.ScoreColumn3:setLeftRight( true, true, 538, 0 )
	self.ScoreColumn3:setTopBottom( true, false, 249, 284 )
	...
	self.ScoreColumn4Shadow:setLeftRight( true, true, 628 + 0.5, 0 + 0.5 )
	self.ScoreColumn4Shadow:setTopBottom( true, false, 249 + 0.5, 284 + 0.5 )
	self.ScoreColumn4Shadow:setText( Engine.Localize( "Revives" ) )
	self.ScoreColumn4Shadow:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	...
	self.ScoreColumn4:setLeftRight( true, true, 628, 0 )
	self.ScoreColumn4:setTopBottom( true, false, 249, 284 )
	...
	self.ScoreColumn5Shadow:setLeftRight( true, true, 711 + 0.5, 0 + 0.5 )
	self.ScoreColumn5Shadow:setTopBottom( true, false, 249 + 0.5, 284 + 0.5 )
	self.ScoreColumn5Shadow:setText( Engine.Localize( "Headshots" ) )
	self.ScoreColumn5Shadow:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	...
	self.ScoreColumn5:setLeftRight( true, true, 711, 0 )
	self.ScoreColumn5:setTopBottom( true, false, 249, 284 )
	...
	self.ScoreColumn6Shadow:setLeftRight( true, true, 838 + 0.5, 0 + 0.5 )
	self.ScoreColumn6Shadow:setTopBottom( true, false, 249 + 0.5, 284 + 0.5 )
	self.ScoreColumn6Shadow:setText( Engine.Localize( "Ping" ) )
	self.ScoreColumn6Shadow:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	...
	self.ScoreColumn6:setLeftRight( true, true, 838, 0 )
	self.ScoreColumn6:setTopBottom( true, false, 249, 284 )
	...
	self.Team1 = LUI.UIList.new( menu, controller, 12, 0, nil, false, false, 0, 0, false, false )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.GameOverShadow:completeAnimation()
				self.GameOverShadow:setAlpha( 0 )
				self.clipFinished( self.GameOverShadow, {} )

				self.GameOver:completeAnimation()
				self.GameOver:setAlpha( 0 )
				self.clipFinished( self.GameOver, {} )

				self.SurvivedShadow:completeAnimation()
				self.SurvivedShadow:setAlpha( 0 )
				self.clipFinished( self.SurvivedShadow, {} )
		...
		GameEnded = {
			DefaultClip = function ()
				...
				self.GameOverShadow:completeAnimation()
				self.GameOverShadow:setAlpha( 1 )
				self.clipFinished( self.GameOverShadow, {} )
				...
				self.SurvivedShadow:completeAnimation()
				self.SurvivedShadow:setAlpha( 1 )
				self.clipFinished( self.SurvivedShadow, {} )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		element.GameOverShadow:close()
		element.GameOver:close()
		element.SurvivedShadow:close()
