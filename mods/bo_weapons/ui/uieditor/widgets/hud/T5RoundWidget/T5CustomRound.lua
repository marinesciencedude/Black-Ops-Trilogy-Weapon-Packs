...
CoD.T5CustomRound.new = function ( menu, controller )
	...
	self.Chalks1:setTopBottom( false, true, -101, -6 )
	self.Chalks1:setImage( RegisterImage( "t5_chalkmarks_1" ) )
	...
	self.Chalks2:setTopBottom( false, true, -101, -6 )
	self.Chalks2:setImage( RegisterImage( "t5_chalkmarks_1" ) )
	...
	self.RoundText:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	...
	self.RoundMiddleTextShadow:setLeftRight( true, true, 32 + 1, 0 + 1 )
	self.RoundMiddleTextShadow:setTopBottom( true, false, 253 + 1, 343 + 1 )
	self.RoundMiddleTextShadow:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	self.RoundMiddleTextShadow:setText( Engine.Localize( "Round" ) )
	self.RoundMiddleTextShadow:setRGB( 0, 0, 0 )
	self.RoundMiddleTextShadow:setScale( 0.5 )
	self:addElement( self.RoundMiddleTextShadow )

	self.RoundMiddleText = LUI.UIText.new()
	self.RoundMiddleText:setLeftRight( true, true, 32, 0 )
	self.RoundMiddleText:setTopBottom( true, false, 253, 343 )
	self.RoundMiddleText:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	self.RoundMiddleText:setText( Engine.Localize( "Round" ) )
	self.RoundMiddleText:setRGB( 0.41, 0, 0 )
	self.RoundMiddleText:setScale( 0.5 )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			Rnd1 = function ()
				...
				local ChalkAnimationStage2 = function ( element, event )
					...
					element:setTopBottom( false, true, -101, -6 )
			...
			Rnd2 = function ()
				...
				local Chalks1AnimationStage7 = function ( element, event )
					if event.interrupted then
						...
						element:setImage( RegisterImage( "t5_chalkmarks_2" ) )
		...
		Rnd2 = {
			DefaultClip = function ()
				...
				self.Chalks1:setAlpha( 1 )
				self.Chalks1:setRGB( 0.41, 0, 0 )
				self.Chalks1:setImage( RegisterImage( "t5_chalkmarks_2" ) )
				self.clipFinished( self.Chalks1, {} )
			...
			Rnd3 = function ()
				...
				local Chalks1AnimationStage7 = function ( element, event )
					if event.interrupted then
						...
						element:setImage( RegisterImage( "t5_chalkmarks_3" ) )
		...
		Rnd3 = {
			DefaultClip = function ()
				...
				self.Chalks1:setAlpha( 1 )
				self.Chalks1:setRGB( 0.41, 0, 0 )
				self.Chalks1:setImage( RegisterImage( "t5_chalkmarks_3" ) )
				self.clipFinished( self.Chalks1, {} )
			...
			Rnd4 = function ()
				...
				local Chalks1AnimationStage7 = function ( element, event )
					if event.interrupted then
						...
						element:setImage( RegisterImage( "t5_chalkmarks_4" ) )
		...
		Rnd4 = {
			DefaultClip = function ()
				...
				self.Chalks1:setAlpha( 1 )
				self.Chalks1:setRGB( 0.41, 0, 0 )
				self.Chalks1:setImage( RegisterImage( "t5_chalkmarks_4" ) )
				self.clipFinished( self.Chalks1, {} )
			...
			Rnd5 = function ()
				...
				local Chalks1AnimationStage7 = function ( element, event )
					if event.interrupted then
						...
						element:setImage( RegisterImage( "t5_chalkmarks_5" ) )
		...
		Rnd5 = {
			DefaultClip = function ()
				...
				self.Chalks1:setAlpha( 1 )
				self.Chalks1:setRGB( 0.41, 0, 0 )
				self.Chalks1:setImage( RegisterImage( "t5_chalkmarks_5" ) )
				self.clipFinished( self.Chalks1, {} )
			...
			Rnd6 = function ()
				...
				local Chalks2AnimationStage3 = function ( element, event )
					if event.interrupted then
						...
						element:setImage( RegisterImage( "t5_chalkmarks_1" ) )
		...
		Rnd7 = {
			DefaultClip = function ()
				...
				self.Chalks2:setAlpha( 1 )
				self.Chalks2:setRGB( 0.41, 0, 0 )
				self.Chalks2:setImage( RegisterImage( "t5_chalkmarks_2" ) )
				self.clipFinished( self.Chalks2, {} )
		...
		Rnd8 = {
			DefaultClip = function ()
				...
				self.Chalks2:setAlpha( 1 )
				self.Chalks2:setRGB( 0.41, 0, 0 )
				self.Chalks2:setImage( RegisterImage( "t5_chalkmarks_3" ) )
				self.clipFinished( self.Chalks2, {} )
		...
		Rnd9 = {
			DefaultClip = function ()
				...
				self.Chalks2:setAlpha( 1 )
				self.Chalks2:setRGB( 0.41, 0, 0 )
				self.Chalks2:setImage( RegisterImage( "t5_chalkmarks_4" ) )
				self.clipFinished( self.Chalks2, {} )
		...
		Rnd10 = {
			DefaultClip = function ()
				...
				self.Chalks2:setAlpha( 1 )
				self.Chalks2:setRGB( 0.41, 0, 0 )
				self.Chalks2:setImage( RegisterImage( "t5_chalkmarks_5" ) )
				self.clipFinished( self.Chalks2, {} )
