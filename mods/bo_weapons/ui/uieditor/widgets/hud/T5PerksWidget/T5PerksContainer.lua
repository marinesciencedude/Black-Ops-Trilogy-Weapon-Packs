...
require( "ui.uieditor.widgets.HUD.T5PerksWidget.T5PerksListItem" )
...
CoD.ZMCustomPerks = {
	...
	},
	{
		...
		image = "t5_specialty_electriccherry",
...
CoD.T5PerksContainer = InheritFrom( LUI.UIElement )
CoD.T5PerksContainer.new = function ( menu, controller )
	...
	self:setClass( CoD.T5PerksContainer )
	self.id = "T5PerksContainer"
	...
	self.PerkList:setWidgetType( CoD.T5PerksListItem )
