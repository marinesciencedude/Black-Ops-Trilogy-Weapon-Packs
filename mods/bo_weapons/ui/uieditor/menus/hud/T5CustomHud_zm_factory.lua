...
LUI.createMenu.T5CustomHud_zm_factory = function ( controller )
	...
	self.DummyFont1:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
	...
	self.DummyFont2:setTTF( "fonts/morris_sans_w04_medium_cond.ttf" )
	...
	self.ZMPerksContainerFactory = CoD.T5PerksContainer.new( self, controller )
	...
	self.T5Notification = CoD.T5Notification.new( self, controller )
	self.T5Notification:setLeftRight( true, true, 0, 0 )
	self.T5Notification:setTopBottom( true, true, 0, 0 )
	self:addElement( self.T5Notification )
	...
	self.CursorHint:setTopBottom( true, true, 456.5, 0 )
	self.CursorHint.cursorhinttext0.FEButtonPanel0:setScale( 0 )
	self.CursorHint.cursorhinttext0.CursorHintText:setScale( 0.7 )
	self.CursorHint.cursorhinttext0.CursorHintText:setTTF( "fonts/helvetica_neue_67_medium_cond.ttf" )
