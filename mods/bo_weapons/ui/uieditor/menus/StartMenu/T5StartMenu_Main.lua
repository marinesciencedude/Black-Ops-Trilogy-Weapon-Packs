require( "ui.uieditor.menus.StartMenu.T5StartMenu_GameOptions_ZM" )
        ...
        if Engine.IsZombiesGame() then
			table.insert( tabList, {
				models = {
					...
					tabWidget = "CoD.T5StartMenu_GameOptions_ZM",
					tabIcon = ""
				},
				properties = {
					tabId = "gameOptions"
...
LUI.createMenu.StartMenu_Main = function ( controller )
	...
	self.PausedText:setLeftRight( true, true, -327, 0 )
	self.PausedText:setTopBottom( true, false, 0 + 37, 92 + 37 )
	self.PausedText:setText( Engine.Localize( "MENU_PAUSED_CAPS" ) )
	self.PausedText:setTTF( "fonts/morris_sans_w04_medium_cond.ttf" )
	self.PausedText:setScale( 0.5 )
	self.PausedText:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_LEFT )
