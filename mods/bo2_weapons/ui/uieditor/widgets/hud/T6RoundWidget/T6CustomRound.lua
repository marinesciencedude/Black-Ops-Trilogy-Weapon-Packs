CoD.T6CustomRound = InheritFrom( LUI.UIElement )
CoD.T6CustomRound.new = function ( menu, controller )
	...
	self:setClass( CoD.T6CustomRound )
	self.id = "T6CustomRound"
	...
	self.Chalks1:setLeftRight( true, false, 0, 95 )
	self.Chalks1:setTopBottom( false, true, -95, 0 )
	self.Chalks1:setImage( RegisterImage( "chalkmarks_1" ) )
	self.Chalks1:setRGB( 0.21, 0, 0 )
	self:addElement( self.Chalks1 )

	self.Chalks2 = LUI.UIImage.new()
	self.Chalks2:setLeftRight( true, false, 0 + 95, 95 + 95 )
	self.Chalks2:setTopBottom( false, true, -95, 0 )
	self.Chalks2:setImage( RegisterImage( "chalkmarks_1" ) )
	self.Chalks2:setRGB( 0.21, 0, 0 )
	...
	self.RoundText:setTTF( "fonts/bigFont.ttf" )
	self.RoundText:setText( Engine.Localize( "" ) )
	self.RoundText:setRGB( 0.21, 0, 0 )
	...
	self.RoundMiddleText:setTopBottom( false, false, -37.5 - 102.5, 37.5 - 102.5 )
	self.RoundMiddleText:setTTF( "fonts/bigFont.ttf" )
	self.RoundMiddleText:setText( Engine.Localize( "Round" ) )
	self.RoundMiddleText:setRGB( 0.21, 0, 0 )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			Rnd1 = function ()
				...
				local ChalkAnimationStage2 = function ( element, event )
					...
					element:setLeftRight( true, false, 0, 95 )
				...
				self.Chalks1:completeAnimation()
				self.Chalks1:setLeftRight( false, false, -47.5 + 32.5, 47.5 + 32.5 )
				self.Chalks1:setTopBottom( false, false, -47.5, 47.5 )
				self.Chalks1:setAlpha( 0 )
			...
			Rnd2 = function ()
				...
				local Chalks1AnimationStage7 = function ( element, event )
					if event.interrupted then
						...
						element:setImage( RegisterImage( "chalkmarks_2" ) )
		...
		Rnd2 = {
			DefaultClip = function ()
				...
				self.Chalks1:setAlpha( 1 )
				self.Chalks1:setRGB( 0.21, 0, 0 )
				self.Chalks1:setImage( RegisterImage( "chalkmarks_2" ) )
				self.clipFinished( self.Chalks1, {} )
			...
			Rnd3 = function ()
				...
				local Chalks1AnimationStage7 = function ( element, event )
					if event.interrupted then
						...
						element:setImage( RegisterImage( "chalkmarks_3" ) )
		...
		Rnd3 = {
			DefaultClip = function ()
				...
				self.Chalks1:setAlpha( 1 )
				self.Chalks1:setRGB( 0.21, 0, 0 )
				self.Chalks1:setImage( RegisterImage( "chalkmarks_3" ) )
				self.clipFinished( self.Chalks1, {} )
			...
			Rnd4 = function ()
				...
				local Chalks1AnimationStage7 = function ( element, event )
					if event.interrupted then
						...
						element:setImage( RegisterImage( "chalkmarks_4" ) )
		...
		Rnd4 = {
			DefaultClip = function ()
				...
				self.Chalks1:setAlpha( 1 )
				self.Chalks1:setRGB( 0.21, 0, 0 )
				self.Chalks1:setImage( RegisterImage( "chalkmarks_4" ) )
				self.clipFinished( self.Chalks1, {} )
			...
			Rnd5 = function ()
				...
				local Chalks1AnimationStage7 = function ( element, event )
					if event.interrupted then
						...
						element:setImage( RegisterImage( "chalkmarks_5" ) )
		...
		Rnd5 = {
			DefaultClip = function ()
				...
				self.Chalks1:setAlpha( 1 )
				self.Chalks1:setRGB( 0.21, 0, 0 )
				self.Chalks1:setImage( RegisterImage( "chalkmarks_5" ) )
				self.clipFinished( self.Chalks1, {} )
			...
			Rnd6 = function ()
				...
				local Chalks2AnimationStage3 = function ( element, event )
					if event.interrupted then
						...
						element:setImage( RegisterImage( "chalkmarks_1" ) )
		...
		Rnd7 = {
			DefaultClip = function ()
				...
				self.Chalks2:setAlpha( 1 )
				self.Chalks2:setRGB( 0.21, 0, 0 )
				self.Chalks2:setImage( RegisterImage( "chalkmarks_2" ) )
				self.clipFinished( self.Chalks2, {} )
		...
		Rnd8 = {
			DefaultClip = function ()
				...
				self.Chalks2:setAlpha( 1 )
				self.Chalks2:setRGB( 0.21, 0, 0 )
				self.Chalks2:setImage( RegisterImage( "chalkmarks_3" ) )
				self.clipFinished( self.Chalks2, {} )
		...
		Rnd9 = {
			DefaultClip = function ()
				...
				self.Chalks2:setAlpha( 1 )
				self.Chalks2:setRGB( 0.21, 0, 0 )
				self.Chalks2:setImage( RegisterImage( "chalkmarks_4" ) )
				self.clipFinished( self.Chalks2, {} )
		...
		Rnd10 = {
			DefaultClip = function ()
				...
				self.Chalks2:setAlpha( 1 )
				self.Chalks2:setRGB( 0.21, 0, 0 )
				self.Chalks2:setImage( RegisterImage( "chalkmarks_5" ) )
				self.clipFinished( self.Chalks2, {} )
