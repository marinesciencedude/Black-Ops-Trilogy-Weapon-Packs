...
function treasure_chest_give_weapon( weapon )
{
	...
	{
		if(isdefined(level.zombie_weapons[weapon.rootWeapon].mysterybox_attachments))
			w_give = self zm_weapons::weapon_give_pap(GetWeapon(weapon.name, level.zombie_weapons[weapon.rootWeapon].mysterybox_attachments)); //need to change to generic name apparently
		else
