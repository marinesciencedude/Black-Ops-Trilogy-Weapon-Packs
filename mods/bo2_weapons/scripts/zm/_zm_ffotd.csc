...
function main_end()
{
	...
	if(GetDvarInt("mutator_bo2_perk_icons") == 1)
	{
		...
		if(GetDvarString("mapname") != "zm_factory_classic")
			clientfield::register( "clientuimodel", "hudItems.perks.doubletap2_bo2", VERSION_SHIP, 2, "int", undefined, !CF_HOST_ONLY, CF_CALLBACK_ZERO_ON_NEW_ENT ); 
	...
	else if(GetDvarInt("mutator_bo2_perk_icons") == 2)
	{
		...
		if(GetDvarString("mapname") != "zm_factory_classic")
			clientfield::register( "clientuimodel", "hudItems.perks.doubletap2_bo2_alt", VERSION_SHIP, 2, "int", undefined, !CF_HOST_ONLY, CF_CALLBACK_ZERO_ON_NEW_ENT ); 
		clientfield::register( "clientuimodel", "hudItems.perks.doubletap_bo2", 1, 2, "int", undefined, 0, 1); 
	}
	...
	{
		clientfield::register("toplayer", "powerup_instant_kill_bo2", 1, 2, "int", &zm_powerups::powerup_state_callback, 0, 1);
		level.zombie_powerups["insta_kill"].client_field_name = "powerup_instant_kill_bo2";
		clientfield::register("toplayer", "powerup_double_points_bo2", 1, 2, "int", &zm_powerups::powerup_state_callback, 0, 1);
		level.zombie_powerups["double_points"].client_field_name = "powerup_double_points_bo2";
		clientfield::register("toplayer", "powerup_fire_sale_bo2", 1, 2, "int", &zm_powerups::powerup_state_callback, 0, 1);
		level.zombie_powerups["fire_sale"].client_field_name = "powerup_fire_sale_bo2";
		clientfield::register("toplayer", "powerup_mini_gun_bo2", 1, 2, "int", &zm_powerups::powerup_state_callback, 0, 1);
		level.zombie_powerups["minigun"].client_field_name = "powerup_mini_gun_bo2";
		clientfield::register("toplayer", "powerup_zombie_blood_bo2", 1, 2, "int", &zm_powerups::powerup_state_callback, 0, 1);
