...
function __init__()
{
	if(GetDvarString("mapname") != "zm_pentagon") //uses its own _zm_weap_ballistic_knife.gsc
	{
		level.weapBallisticKnife 					= GetWeapon( "t5_bk_base_normal" );
		level.weapBallisticKnifeUpgraded 			= GetWeapon( "t5_bk_base_upgraded" );
		level.weapBallisticKnifeWithBowie			= GetWeapon( "t5_bk_bowie_normal" );
		level.weapBallisticKnifeWithBowieUpgraded 	= GetWeapon( "t5_bk_bowie_upgraded" );
		level.weapBallisticKnifeWithSickle			= GetWeapon( "t5_bk_sickle_normal" );
		level.weapBallisticKnifeWithSickleUpgraded	= GetWeapon( "t5_bk_sickle_upgraded" );
...
function melee_logic(){
	...
	if(melee_weapon_structs.size
		&& GetDvarString("mapname") != "zm_die" //uses its own
		&& GetDvarString("mapname") != "zm_pentagon") //already has it
	{
		zm_melee_weapon::init("t5_bk_bowie_wallbuy", "t5_bk_bowie_flourish", "t5_bk_bowie_normal", "t5_bk_bowie_upgraded", 3000, "bowie_upgrade", &"ZOMBIE_WEAPONCOSTONLY_CFILL", "bowie", undefined);
	...
	if(melee_weapon_structs.size)
	{
		zm_melee_weapon::init("t5_bk_sickle_wallbuy", "t5_bk_sickle_flourish", "t5_bk_sickle_normal", "t5_bk_sickle_upgraded", 3000, "sickle_upgrade", &"ZOMBIE_WEAPONCOSTONLY_CFILL", "sickle", undefined);
	...
	if(GetDvarString("mapname") != "zm_die") //uses its own
	{
