...
function reward_packed_weapon(player, s_stat)
{
	...
	{
		a_weapons = array("t6_galil", "t6_stg44", "t6_scarh");
...
function reward_double_tap(player, s_stat)
{
	...
	if( ( GetGametypeSetting(mutator_doubletap) == 2 && (player hasperk("specialty_doubletap2") || player zm_perks::has_perk_paused("specialty_doubletap2")) ) || ( GetGametypeSetting(mutator_doubletap) == 1 && (player hasperk("specialty_rof") || player zm_perks::has_perk_paused("specialty_rof")) ) )
	{
