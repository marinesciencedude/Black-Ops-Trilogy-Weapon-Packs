...
function dig_up_grenade(player)
{
	...
	w_grenade = getweapon("frag_grenade_potato_masher");
...
function dig_up_weapon(digger)
{
	...
	case 2:
		...
		break;
	case 3:
		starting_weapon = "pistol_c96";
		break;
	}
	var_43f586fe = array(getweapon(starting_weapon), getweapon("t4_db_saw"), getweapon("t4_m1897"));
