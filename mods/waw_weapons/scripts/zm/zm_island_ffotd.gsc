...
function main_end()
{
	...
	level.var_f3798849 = getweapon("t4_kar98k_scope");
	level.var_c29d7558 = getweapon("t4_panzerschreck");
	level.var_b00f35c1 = getweapon("t4_g43");
	
	level.var_b39227d1 = array(getweapon("t4_mp40"), getweapon("t4_db"), getweapon("t4_mp44"), getweapon("t4_m1919"), getweapon("t4_m1"), getweapon("t4_type100"));
	...
	level.var_8aee1d4 = array(/*getweapon("pistol_shotgun_dw"),*/ getweapon("t4_m1897"), getweapon("t4_ptrs"), raygun, getweapon("bowie_knife"), getweapon("cymbal_monkey"));
