...
require( "ui.uieditor.widgets.HUD.T4PerksWidget.T4PerksListItem" )
...
CoD.ZMPerks = {
	{
		...
		image = "t4_specialty_additionalprimaryweapon",
	...
	},
	{
		...
		image = "t4_specialty_quickrevive",
	...
	},
	{
		...
		image = "t4_specialty_electriccherry",
