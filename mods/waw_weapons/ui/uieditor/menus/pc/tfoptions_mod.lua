...
DataSources.TFOptionsModP1 = DataSourceHelpers.ListSetup("PC.TFOptionsP1", function (f26_arg0)
	local f26_local0 = {}
	table.insert(f26_local0, {models = {label = "Double Pack-a-Punch", description = "Whether weapons can be pack-a-punched multiple times or not.", profileVarName = "double_packapunch", widgetType = "tfcheckbox"}, properties = CoD.TFPCUtil.OptionsGenericCheckboxProperties})
	--table.insert(f26_local0, {models = {label = "Perk: Root Beer", description = "Which version of Double Tap to use.", profileVarName = "doubletap", dataSource = "ModOptionsDoubleTap", widgetType = "dropdown"}, properties = CoD.TFPCUtil.OptionsGenericDropdownProperties})
	table.insert(f26_local0, {models = {label = "Perk Machine", description = "Which perk machine out of PhD Flopper/Widow's Wine will be spawned in the game. SELECTING WIDOW'S WINE WILL RESTART THE MAP SHORTLY AFTER SPAWNING.", profileVarName="phd_widows", dataSource="ModOptionsPhDWidows", widgetType="dropdown"}, properties = CoD.TFPCUtil.OptionsGenericDropdownProperties})
	table.insert(f26_local0, {models = {label = "Widow's Wine", description = "If Widow's Wine should exist through Der Wunderfizz, or at all in the map.", profileVarName = "widowswine_existence", dataSource = "ModOptionsWidowsWine", widgetType = "dropdown"}, properties = CoD.TFPCUtil.OptionsGenericDropdownProperties})
	table.insert(f26_local0, {models = {label = "Black Ops Perk Icons", description = "If the perk icons should be set to the Original Black Ops ones", profileVarName = "bo_perk_icons", widgetType = "tfcheckbox"}, properties = CoD.TFPCUtil.OptionsGenericCheckboxProperties})
	--table.insert(f26_local0, {models = {label = "Black Ops Power-Up Icons", description = "If the power-up icons should be set to the Original Black Ops ones", profileVarName = "bo_powerup_icons", widgetType = "tfcheckbox"}, properties = CoD.TFPCUtil.OptionsGenericCheckboxProperties})
	table.insert(f26_local0, {models = {label = "Deadshot Daiquiri Price", description = "1500 - Black Ops III price, 1000 - Black Ops I/II price. SELECTING 1000 WILL RESTART THE MAP SHORTLY AFTER SPAWNING INTO THE GAME.", profileVarName = "deadshot_price", dataSource = "ModOptionsDeadshot", widgetType = "dropdown"}, properties = CoD.TFPCUtil.OptionsGenericDropdownProperties})
	table.insert(f26_local0, {models = {label = "Gobblegum Machines", description = "If Gobblegum Machines should be usable. SELECTING REPLACED WILL RESTART THE MAP SHORTLY AFTER SPAWNING INTO THE GAME.", profileVarName = "enable_gobblegum", dataSource = "ModOptionsGobblegum", widgetType = "dropdown"}, properties = CoD.TFPCUtil.OptionsGenericDropdownProperties})
	--table.insert(f26_local0, {models = {label = "AK47", description = "Add AK47 to the mystery box. The Red Mist has an underbarrel flamethrower and dual mags, the Reznov's Revenge matches the Black Ops II version.", profileVarName = "ak47", dataSource = "ModOptionsAK47", widgetType = "dropdown"}, properties = CoD.TFPCUtil.OptionsGenericDropdownProperties})
	table.insert(f26_local0, {models = {label = "AK47", description = "Add AK47 to the mystery box and Reznov's Revenge as its PaP version.", profileVarName = "ak47", dataSource = "ModOptionsAK47", widgetType = "dropdown"}, properties = CoD.TFPCUtil.OptionsGenericDropdownProperties})
	table.insert(f26_local0, {models = {label = "Uzi", description = "Add Uzi to the mystery box. SP/MP has a 32+192/64+448 base/PaP ammo capacity, BO II has a 25+275/25+300 base/PaP ammo capacity", profileVarName = "uzi", dataSource = "ModOptionsUzi", widgetType = "dropdown"}, properties = CoD.TFPCUtil.OptionsGenericDropdownProperties})
	table.insert(f26_local0, {models = {label = "AUG Wallbuy", description = "If the Wii AUG wallbuy should exist on Kino der Toten. SELECTING THIS OPTION WILL RESTART THE MAP SHORTLY AFTER SPAWNING INTO THE GAME.", profileVarName = "aug", widgetType = "tfcheckbox"}, properties = CoD.TFPCUtil.OptionsGenericCheckboxProperties})
	table.insert(f26_local0, {models = {label = "Mine Wallbuy", description = "If the wallbuy should be Claymores instead of Trip Mines. SELECTING TRIP MINES WILL RESTART THE MAP SHORTLY AFTER SPAWNING INTO THE GAME.", profileVarName = "claymore", dataSource = "ModOptionsClaymore", widgetType = "dropdown"}, properties = CoD.TFPCUtil.OptionsGenericDropdownProperties})
	table.insert(f26_local0, {models = {label = "Skorpion", description = "Add Skorpion to the mystery box", profileVarName = "skorpion", widgetType = "tfcheckbox"}, properties = CoD.TFPCUtil.OptionsGenericCheckboxProperties})
	table.insert(f26_local0, {models = {label = "Stoner 63", description = "Add Stoner 63 to the mystery box", profileVarName = "stoner63", widgetType = "tfcheckbox"}, properties = CoD.TFPCUtil.OptionsGenericCheckboxProperties})
	table.insert(f26_local0, {models = {label = "Ray Gun Mark II", description = "Enable Ray Gun Mark II in the mystery box", profileVarName = "raygunmkii", widgetType = "tfcheckbox"}, properties = CoD.TFPCUtil.OptionsGenericCheckboxProperties})
	table.insert(f26_local0, {models = {label = "Enable Space Monkeys", description = "Enable Monkey Rounds on Ascension", profileVarName = "spacemonkey", widgetType = "tfcheckbox"}, properties= CoD.TFPCUtil.OptionsGenericCheckboxProperties})
	--table.insert(f26_local0, {models = {label = "Classic Round Change Sound", description = "Restore classic round change sounds.", profileVarName = "round_change", widgetType = "tfcheckbox"}, properties = CoD.TFPCUtil.OptionsGenericCheckboxProperties})
	--table.insert(f26_local0, {models = {label = "Hellhound Headshot Immunity", description = "Make headshots on hellhounds deal chest damage.", profileVarName = "hellhound_headshot", widgetType = "tfcheckbox"}, properties = CoD.TFPCUtil.OptionsGenericCheckboxProperties})
	return f26_local0
end, true)

DataSources.TFOptionsModP1.getWidgetTypeForItem = function (f27_arg0, f27_arg1, f27_arg2)
	if f27_arg1 then
...
DataSources.TFOptionModCategories = DataSourceHelpers.ListSetup("PC.TFOptionModCategories", function (f28_arg0)
	local f28_local0 = {}
	table.insert(f28_local0, {models = {tabIcon = CoD.buttonStrings.shoulderl}, properties = {m_mouseDisabled = true}})
	table.insert(f28_local0, {models = {tabName = "ZOMBIE OPTIONS", tabWidget = "CoD.TFOptions_Mod_P1"}})
...
LUI.createMenu.TFOptionsModPage = function (InstanceRef)
	local HudRef = CoD.Menu.NewForUIEditor("TFOptionsModPage")
	if f0_local2 then
	...
	HudRef.buttonModel = Engine.CreateModel(Engine.GetModelForController(InstanceRef), "TFOptionsModPage.buttonPrompts")
	...
	f31_local7.grid:setDataSource("TFOptionModCategories")
	...
	LUI.OverrideFunction_CallOriginalSecond(HudRef, "close", function (Sender)
		...
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(Engine.GetModelForController(InstanceRef), "TFOptionsModPage.buttonPrompts"))
	end)
	if f0_local3 then
