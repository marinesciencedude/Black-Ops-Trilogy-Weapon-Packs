...
-- WAW Widgets
require( "ui.uieditor.menus.StartMenu.T4StartMenu_Main" )
require( "ui.uieditor.widgets.HUD.T4AmmoWidget.T4AmmoContainer" )
require( "ui.uieditor.widgets.HUD.T4NotificationWidget.T4Notification" )
require( "ui.uieditor.widgets.HUD.T4PerksWidget.T4PerksContainer" )
require( "ui.uieditor.widgets.HUD.T4ReviveWidget.T4ReviveContainer" )
require( "ui.uieditor.widgets.HUD.T4RoundWidget.T4RoundContainer" )
require( "ui.uieditor.widgets.HUD.T4ScoreWidget.T4ScoreContainer" )
require( "ui.uieditor.widgets.HUD.T4ScoreboardWidget.T4Scoreboard" )
...
LUI.createMenu.T4Hud_zm_factory = function ( controller )
	...
	self.DummyFont1:setTTF( "fonts/itc_legacy_sans_bold.ttf" )
	...
	self.ZMPerksContainerFactory = CoD.T4PerksContainer.new( self, controller )
	...
	self.CursorHint:setTopBottom( true, true, 455, 0 )
	self.CursorHint.cursorhinttext0.FEButtonPanel0:setScale( 0 )
	self.CursorHint.cursorhinttext0.CursorHintText:setScale( 1.2 )
	self.CursorHint.cursorhinttext0.CursorHintText:setTTF( "fonts/itc_legacy_sans_bold.ttf" )
	...
	self.ScoreboardWidget = CoD.T4Scoreboard.new( self, controller )
